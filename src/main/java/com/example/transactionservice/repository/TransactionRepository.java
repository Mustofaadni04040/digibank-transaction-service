...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("""
    SELECT t FROM Transaction t WHERE (t.fromAccountNumber = :accNum OR t.toAccountNumber = :accNum) AND t.createdAt BETWEEN :start AND :end ORDER BY t.createdAt DESC
    """)
